...
abstract class BaseWilayahPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Wilayah', 'Kecamatan', 'Kelurahan', ),
		BasePeer::TYPE_COLNAME => array (WilayahPeer::ID, WilayahPeer::WILAYAH, WilayahPeer::KECAMATAN, WilayahPeer::KELURAHAN, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'wilayah', 'kecamatan', 'kelurahan', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Wilayah' => 1, 'Kecamatan' => 2, 'Kelurahan' => 3, ),
		BasePeer::TYPE_COLNAME => array (WilayahPeer::ID => 0, WilayahPeer::WILAYAH => 1, WilayahPeer::KECAMATAN => 2, WilayahPeer::KELURAHAN => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'wilayah' => 1, 'kecamatan' => 2, 'kelurahan' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/BankSampah.php';

						$c = new Criteria();
			
			$c->add(BankSampahPeer::ID_WILAYAH, $obj->getId());
			$affectedRows += BankSampahPeer::doDelete($c, $con);

			include_once 'lib/model/IpalKomunal.php';

						$c = new Criteria();
			
			$c->add(IpalKomunalPeer::ID_WILAYAH, $obj->getId());
			$affectedRows += IpalKomunalPeer::doDelete($c, $con);

			include_once 'lib/model/Kader.php';

						$c = new Criteria();
			
			$c->add(KaderPeer::ID_WILAYAH, $obj->getId());
