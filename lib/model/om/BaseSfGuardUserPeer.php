...
abstract class BaseSfGuardUserPeer {
	...
	{
		include_once 'lib/model/map/SfGuardUserMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.SfGuardUserMapBuilder');
	}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/SfGuardRememberKey.php';
			...
			include_once 'lib/model/SfGuardUserGroup.php';
			...
			include_once 'lib/model/SfGuardUserPermission.php';
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/SfGuardUserMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.SfGuardUserMapBuilder');
}
